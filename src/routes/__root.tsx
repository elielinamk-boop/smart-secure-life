...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Intelligent biometric access control, smart home automation, video analytics, and building management — powered by our proprietary AI platform." },
      { name: "author", content: "Talesso" },
